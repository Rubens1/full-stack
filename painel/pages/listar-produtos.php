...
<div class="box-content">
	...
	<?php 
		...
		$sql->execute();
		if($sql->rowCount() >0){
		Painel::alert('atencao', 'Você está com produtos em falta! Clique <a href="'.INCLUDE_PATH_PAINEL_LOJA.'listar-produtos?pendentes">aqui</a> para visualizar-los');
		}
	 ?>
	<div class="boxes">
		<?php 
		...
		<div class="box-single-wraper">
		  <div class="box-single">
			...
			<div class="body-box">
				...
				<div class="group-btn">
					<a item_id="<?php echo $value['id']; ?>" class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL_LOJA;?>listar-produtos?deletar=<?php echo $value['id'];?>"><i class="fa fa-times"></i> Excluir</a>
	...
	<?php 
		if(isset($_POST['atualizar'])){
			...
			if($quantidade < 0){
				...
				MySql::conectar()->exec("UPDATE `tb_admin.estoque` SET quantidade = $quantidade WHERE id = $produto_id");
			Painel::alert('sucesso','Você atualizou a quantidade do produto com ID : <b>'.$_POST['produto_id'].'</b> Para ver a Lista clique <a href="'.INCLUDE_PATH_PAINEL.'listar-produtos">aqui</a>');
			}
		}
			...
			<div class="body-box">
				<div class="box-imagem ">
					...
					<?php
					 ...
					 ?>
				<img  src="<?php echo INCLUDE_PATH_PAINEL_LOJA ?>uploads/<?php echo $imagemSingle; ?>" />
				<?php } ?>
			</div>
				<p><b class=""><i></i>Nome do Produto:</b> <?php echo $value['nome']; ?></p>
				<p><b class=""><i></i>Descrição:</b> <?php echo $value['descricao']; ?></p>
