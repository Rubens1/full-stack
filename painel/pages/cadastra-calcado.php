<div class="box-content">
		<div class="body-box">
            <div class="titulo">
                <h2><i class="fas fa-shoe-prints"></i> Cadastrar Produto</h2>
            </div>
			...
			?>
					...
					<div ref="tamanho_numero" class="form-group col-sm-12 tamanho_numero">
					<label>Tamanho do produto: de 34 a 60 </label><br>
					<?php for($i = 34; $i <= 60; $i++){ ?>
						<input style="margin-left: 5px;" type="checkbox" name="tamanho[]" value="<?php echo $i; ?>"> <?php echo $i; ?>
					<?php } ?>
