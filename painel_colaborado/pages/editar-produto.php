...
<div class="card-title"><i class="fas fa-edit"></i> Informações do produto</div>
	<form method="post" action="<?php echo INCLUDE_PATH_PAINEL_COLABORADO ?>editar-produto?id=<?php echo $id;?>" enctype="multipart/form-data">
		<?php 
			if(isset($_POST['acao'])){
				$nome = $_POST['nome'];
				...
				if($sucesso){
					...
					Painel::alert('secesso','Você atualizou seu produto com sucesso!');
					$sql = MySql::conectar()->prepare("SELECT * FROM `tb_admin.estoque` WHERE id = ?");
					$sql->execute(array($id));
		 ...
		 ?>
				...
				<div class="form-group col-sm-12">
					...
					<input type="text" class="form-control col-lg-3" name="largura" value="<?php echo $infoProduto['largura']; ?>">
				</div>
				<div class="form-group col-sm-12">
					<label>Altura do produto: </label>
					<input type="text" class="form-control col-lg-3" name="altura" value="<?php echo $infoProduto['altura']; ?>">
				</div>
				<div class="form-group col-sm-12">
					<label>Comprimento do produto: </label>
					<input type="text" class="form-control col-lg-3" name="comprimento" value="<?php echo $infoProduto['comprimento']; ?>">
				</div>
				<div class="form-group col-sm-12">
					<label>Peso do produto: </label>
					<input type="text" class="form-control col-lg-3" name="peso" value="<?php echo $infoProduto['peso']; ?>">
				</div>
				<div class="form-group col-sm-12">
				...
				<div class="form-group col-sm-12">
					<label>Preço: </label>
					<input type="text" class="form-control" name="preco" value="<?php echo $infoProduto['preco']; ?>">
				</div>
	...
	<div class="box-single-wraper">
		  ...
		  <div class="box-single editar">
			...
			<div class="group-btn center">
				<a class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL_COLABORADO?>editar-produto?id=<?php echo $id; ?>&deletarImagem=<?php echo $value['imagem']; ?>"><i class="fa fa-times"></i> Excluir</a>
			</div>
		</div>
	</div>
	  </div>
