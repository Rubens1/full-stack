...
<div class="page-produto">
  <div class="page-container">
    <div class="pesquisa-filter">
      <form id="filter-form" method="post" action="<?php echo INCLUDE_PATH?>ajax/busca.php">
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="preco_min" class="form-control mascara" placeholder="Digite o preço mínimo">
        </div>
        <div class="form-group">
          <label>Preço máximo</label>
          <input type="text" name="preco_max" class="form-control mascara" placeholder="Digite o preço máximo">
        </div>
      </form>
